-- Fix get_backtest_results to return complete summary data including ROI, CAGR, contributions, and fees
...
COMMENT ON FUNCTION public.get_backtest_results IS 'Get complete back-test results including ROI, CAGR, contributions, fees, and daily data';
