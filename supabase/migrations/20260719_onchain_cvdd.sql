-- 20260719_onchain_cvdd.sql
-- =============================================================================
-- Add CVDD (Cumulative Value Coin Days Destroyed) support to On-Chain Charts.
-- Source input: Research Bitcoin cointime_statistics/coinblock_value_cum_destroyed.
-- Formula: CVDD = (coinblock_value_cum_destroyed / 144) / market_age_days / 6,000,000.
-- =============================================================================
alter table lth_pvr.onchain_pvr_daily
  add column if not exists coinblock_value_cum_destroyed numeric(38,8),
  add column if not exists cvdd numeric(38,8);
