...
```
**Notes:** Deferred to 2026-02-22 03:05 UTC
...
LIMIT 5;
```
**Notes:** Check that amount_pct values match historical patterns
...
```
**Notes:** Requires price action near -1.0σ threshold to observe transition
...
LIMIT 10;
```
**Notes:** Requires momentum slowdown to trigger HOLD in +0.5σ to +2.0σ range
...
LIMIT 10;
```
**Notes:** Requires price action: touch +1.0σ to +2.0σ, then retrace below
