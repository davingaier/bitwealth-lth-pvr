...
jr = [
    ...
    ("2.8", "The Juristic Representative shall appoint at least one Key Individual who will "
            ...
            "appointed Key Individual is Guy Algeo [[Guy Algeo ID number — to confirm]]. "
            ...
            "applicable fit-and-proper requirements. Until such time, Guy Algeo shall act as the "
            "Key Individual of the Juristic Representative, whereafter the Parties shall record "
            "the change of Key Individual in writing and effect the requisite notification to "
            "the FSCA."),
...
plain(doc, "The Appointing FSP: [[Finova registered address, email address to confirm]]",
      space_after=2)
plain(doc, "The Juristic Representative: BitWealth Asset Managers (Pty) Ltd, 89 Bloekom Curve, "
           "Terenure ext. 16, Kempton Park, Gauteng, South Africa, 1619. "
...
for line in ["For the Appointing FSP:  Signed __________________   Name [[Finova signatory]]   Date __________",
